...
if __name__ == '__main__':
  ...
  elif args.part == 'train_s':
      imdb, roidb, ratio_list, ratio_index = combined_roidb(args.s_imdb_name, False)
  elif args.part == 'train_t':
  ...
  loaded = [k for k in checkpoint['model'] if k in fasterRCNN.state_dict()]
  print(loaded)
