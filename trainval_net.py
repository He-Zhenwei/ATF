...
from model.faster_rcnn.vgg1 import vgg16
...
def parse_args():
  ...
  parser.add_argument('--save_dir', dest='save_dir',
                      help='directory to save models', default="./output/tt_only",
                      type=str)
...
if __name__ == '__main__':
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    if epoch==args.max_epochs or epoch%2 == 0:
        save_name = os.path.join(output_dir, 'only_target_baseline_%d.pth' % epoch)
        save_checkpoint({
